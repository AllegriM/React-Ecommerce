...
import { AmountContext, AmountContextProvider } from '../Context/amountSelContext'
                            ...
                            <div className='seller-info'>
                                ...
                                <div>
                                    <span className="andes-button__content">
                                        ...
                                        <SelectQuantity prodQuantity={data.available_quantity} setProdAmount={setProdAmount} cart={cart} item={data} />
